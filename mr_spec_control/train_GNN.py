...
if __name__ == "__main__":
    ...
    experiment_config.on_policy_n_envs_per_worker = 3 # Number of vmas vectorized enviornemnts (each will collect up to max_steps steps, see max_steps in task_config -> 50 * max_steps = 5_000 the number above)
    ...
    experiment_config.evaluation_episodes = 3 # Number of vmas vectorized enviornemnts used in evaluation
