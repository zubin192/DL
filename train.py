...
def vmas_env_EA_train_static(
    ...
    **kwargs
    ...
    pol_pop = [SpecializationPolicy(combined_obs.shape[1],
                                    num_agents-1,
                                    num_modes,
                                    device=device,
...
def vmas_env_EA_train_random(
    ...
    **kwargs
    ...
    pol_pop = [SpecializationPolicy(combined_obs.shape[1], num_agents-1, num_modes, device=device) for _ in range(num_pols)]
